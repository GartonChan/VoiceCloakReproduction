...
def optimizer(delta, Xs, steps):
    ...
    with open('selftesting_results.txt', 'a') as f:
...
for i in range(len(file_name)):
    ...
    after_RIR_path = os.getcwd() + "/afterRIRSelfSampling/afterRIR_" + file_name[i]
    after_optimizer_path = os.getcwd() + "/processedSelfSampling/processed_" + file_name[i]
